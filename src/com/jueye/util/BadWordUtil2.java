...
import com.jueye.wx.HttpUtil;

public class BadWordUtil2 {
//	public static String filePath =HttpUtil.sendPost("http://localhost:8080/WxTravel/txt/dictionary.txt");//敏感词库文件路径
	...
	public static int BadWordNum(String word,String filePath){
...
//		System.out.println("待检测语句字数：" + word.length());
		long beginTime = System.currentTimeMillis();
		Set<String> set = BadWordUtil2.getBadWord(word, 2);
...
//		System.out.println("总共消耗时间为：" + (endTime - beginTime));
	...
	public static void main(String[] args) {
		if(BadWordNum("习近平","WebRoot/txt/dictionary.txt")!=0)
		System.out.print("存在敏感词汇，请重新输入！");
	}
}
